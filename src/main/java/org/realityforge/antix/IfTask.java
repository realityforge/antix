   ...
   extends Task
{
   ...
   {
      if ( !conditions.containsSingleCondition() )
      {
         throw new BuildException( "Must specify exactly one condition." );
      }
      if ( null == macroDef )
      {
         throw new BuildException( "Must specify a sequential task to execute." );
      }
   }
